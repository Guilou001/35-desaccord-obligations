...
#set document(title: "Désaccord des modèles et choix d'obligations", author: "Guillaume Vaudescal")
#set page(
  paper: "a4",
...
$ overline(mu)_(i,t)=1/6 sum_(m=1)^6 hat(mu)_(i,t)^((m)), quad d_(i,t)=sqrt(1/5 sum_(m=1)^6 (hat(mu)_(i,t)^((m))-overline(mu)_(i,t))^2) $
...
$ s_(i,t)=op("rang")_(t) (overline(mu)_(i,t))-1/2 op("rang")_(t) (d_(i,t)) $
...
$ k_t=1-c sum_i abs(k_t w_(i,t)-b_(i,t)) $
...
#figure(image("../results/figures/desaccord_erreur.svg", width: 100%), caption: [Chaque barre est une moyenne temporelle des moyennes mensuelles du groupe. Les erreurs et rendements sont ceux du mois suivant, tandis que la volatilité est historique.])
...
$ op("rang")_(t) (abs(r_(i,t+1)-overline(mu)_(i,t)))=a_t+b_t op("rang")_(t) (d_(i,t))+theta_t^T C_(i,t)+u_(i,t+1) $
...
#figure(image("../results/figures/information_conditionnelle.svg", width: 100%), caption: [Chaque point est la moyenne d'un coefficient mensuel. Les intervalles rééchantillonnent des blocs de douze mois. Les variables partagent l'échelle des rangs, entre zéro et un.])
...
#table(
  ...
  inset: 5pt,
    ...
    [0,025],
    [0,058],
    [Crédit normalisé par duration et écart],
    [0,013],
    [0,003],
    [0,023],
)
...
$ C E_gamma=12 overline(r)-6 gamma s_r^2, quad gamma=5 $
...
#table(
  ...
  inset: 5pt,
    ...
    [1,80],
    [11,34],
    [Erreurs passées pénalisées],
    [4,02],
    [5,27],
    [2,27],
    [11,86],
    [Volatilité passée pénalisée],
    [3,96],
    [5,31],
    [2,21],
    [11,80],
    [Toutes les obligations admissibles],
    [3,26],
    [5,79],
    [1,42],
    [0,72],
...
#figure(image("../results/figures/couts_classement.svg", width: 100%), caption: [Les écarts sont calculés relativement au classement par prévision moyenne, au même coût. Les lignes relient uniquement les scénarios fixés avant le test.])
...
#figure(image("../results/figures/placebo.svg", width: 100%), caption: [La distribution représente les redistributions conditionnelles. Le trait bleu utilise le vrai désaccord. Le trait orange utilise seulement la prévision moyenne.])
...
\[1\] Bali, T. G., Kelly, B., Mörke, M. et Rahman, J. 2026. Machine Forecast Disagreement. Review of Financial Studies. #link("https://doi.org/10.1093/rfs/hhag042")[DOI].

\[2\] Dickerson, A., Nozawa, Y. et Robotti, C. 2025. Factor Investing with Delays. Document de travail du 23 juillet. #link("https://www.ier.hit-u.ac.jp/Common/publication/DP/DPS-A771.pdf")[Texte universitaire].

\[3\] Open Source Bond Asset Pricing. Archive des prévisions, avril 2026. #link("https://openbondassetpricing.com/machine-learning-data/")[Fichiers et documentation].

\[4\] French, K. Research Data Factors. #link("https://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html")[Données et conventions].

\[5\] Bailey, D., Borwein, J., López de Prado, M. et Zhu, Q. 2017. The Probability of Backtest Overfitting. Journal of Computational Finance 20. #link("https://doi.org/10.21314/JCF.2016.322")[DOI].

\[6\] Bailey, D. et López de Prado, M. 2014. The Deflated Sharpe Ratio. Journal of Portfolio Management 40, 94 à 107. #link("https://doi.org/10.3905/jpm.2014.40.5.094")[DOI].
